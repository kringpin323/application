<?php require('header.php') ?>
        ...
        <div id="divmiddle" style=" text-align :left; float :left; width :60%; height :auto; font-family:Verdana ; padding-left: 20px;">
            ...
            <ul><li>亲，你怎么又受伤啦！我们联系火星总部查找到您操作失败的原因：</span></li></ul>
            <?php
                    if(!empty($_SESSION['test']))
                    {
                        echo '<ul><li><span style=" color:red ">'.$_SESSION['test'].'</li></ul>';
                    }
                    if(!empty($_SESSION['nameword']))
                    {
                        echo '<ul><li><span style=" color:red ">'.$_SESSION['nameword'].'</li></ul>';
                    }
                        
            ?>
            <ul><li>没有通过正常途径来到该页面！</li></ul>
