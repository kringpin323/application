...
<?php require('body_comment.php') ?>
 		...
 		<div align="center" style="font-size:10pt;">   
            ...
            <span id="LabelResult" style="display:inline-block;font-family:Arial;height:16px;font-family: Verdana">查询结果：</span>
                ...
                <a href="#jump" id="dingwei"><font color = 'red' style="font-size:11pt;height:24px;width:100px;">点击这里，定位到您要查看的评论</font></a>
         ...
         <div align="center" style="font-size:15pt;" id="bottomZ">
            <a href="#navcontainer"><font color='red' style="font-size:15pt;height:24px;width:100px;">回到顶部</font></a>
        </div>
